 ...
 *
 * Provides both high-level ScriptService API and low-level PythonWrapper
 * access.
 *
...
private:
    ...
    static auto handleServiceAction(
        ...
        std::function<crow::response(std::shared_ptr<lithium::ScriptService>)>
            func) -> crow::response {
        try {
            auto service = mService.lock();
            if (!service || !service->isInitialized()) {
                spdlog::error("ScriptService unavailable for command: {}",
                              command);
                return ResponseBuilder::internalError(
                    "ScriptService unavailable");
            }
            return func(service);
    ...
    static auto handleWrapperAction(
        ...
        try {
            ...
            if (!wrapper) {
                spdlog::error("PythonWrapper unavailable for command: {}",
                              command);
                return ResponseBuilder::internalError(
                    "PythonWrapper unavailable");
            }
            return func(wrapper);
...
public:
    void registerRoutes(lithium::server::ServerApp& app) override {
        ...
        CROW_ROUTE(app, "/api/python/executeFunction")
            .methods("POST"_method)(&PythonController::apiExecuteFunction,
                                    this);
        ...
        CROW_ROUTE(app, "/api/python/statistics/reset")
            .methods("POST"_method)(&PythonController::apiResetStatistics,
                                    this);
        ...
        CROW_ROUTE(app, "/python/getObjectAttribute")
            .methods("POST"_method)(&PythonController::getObjectAttribute,
                                    this);
        CROW_ROUTE(app, "/python/setObjectAttribute")
            .methods("POST"_method)(&PythonController::setObjectAttribute,
                                    this);
    ...
    crow::response apiExecute(const crow::request& req) {
        ...
        return handleServiceAction("execute", [&body](auto service) {
            ...
            if (body.contains("timeout")) {
                config.timeout =
                    std::chrono::milliseconds(body["timeout"].get<int>());
            }
    ...
    crow::response apiExecuteFunction(const crow::request& req) {
        ...
        return handleServiceAction("executeFunction", [&body](auto service) {
            ...
            nlohmann::json args = body.value("args", nlohmann::json::object());
            auto result =
                service->executePythonFunction(moduleName, functionName, args);
    ...
    crow::response apiNumpyOp(const crow::request& req) {
        auto body = nlohmann::json::parse(req.body, nullptr, false);
        if (body.is_discarded() || !body.contains("operation") ||
            !body.contains("arrays")) {
            return ResponseBuilder::badRequest(
                "Missing 'operation' or 'arrays'");
        }
    ...
    void loadScript(const crow::request& req, crow::response& res) {
        try {
            ...
            res =
                handleWrapperAction(body, "loadScript", [&body](auto wrapper) {
                    wrapper->load_script(body["script_name"].get<std::string>(),
    ...
    void unloadScript(const crow::request& req, crow::response& res) {
        try {
            auto body = nlohmann::json::parse(req.body);
            res = handleWrapperAction(
                body, "unloadScript", [&body](auto wrapper) {
    ...
    void reloadScript(const crow::request& req, crow::response& res) {
        try {
            auto body = nlohmann::json::parse(req.body);
            res = handleWrapperAction(
                body, "reloadScript", [&body](auto wrapper) {
    ...
    void callFunction(const crow::request& req, crow::response& res) {
        try {
            auto body = nlohmann::json::parse(req.body);
            res = handleWrapperAction(
                body, "callFunction", [&body](auto wrapper) {
    ...
    void callFunctionAsync(const crow::request& req, crow::response& res) {
        try {
            auto body = nlohmann::json::parse(req.body);
            res = handleWrapperAction(
                body, "callFunctionAsync", [&body](auto wrapper) {
                    auto future =
                        wrapper->template async_call_function<py::object>(
                            body["alias"].get<std::string>(),
                            body["function_name"].get<std::string>());
                    auto result = future.get();
                    if (!result.is(pybind11::none())) {
    ...
    void batchExecute(const crow::request& req, crow::response& res) {
        try {
            auto body = nlohmann::json::parse(req.body);
            res = handleWrapperAction(
                body, "batchExecute", [&body](auto wrapper) {
                    ...
                    return ResponseBuilder::success(
                        nlohmann::json{{"results", resultArray}});
                });
        } catch (const nlohmann::json::exception& e) {
            res = ResponseBuilder::invalidJson(e.what());
        }
    ...
    void getVariable(const crow::request& req, crow::response& res) {
        try {
            auto body = nlohmann::json::parse(req.body);
            res =
                handleWrapperAction(body, "getVariable", [&body](auto wrapper) {
    ...
    void setVariable(const crow::request& req, crow::response& res) {
        try {
            auto body = nlohmann::json::parse(req.body);
            res =
                handleWrapperAction(body, "setVariable", [&body](auto wrapper) {
    ...
    void getFunctionList(const crow::request& req, crow::response& res) {
        try {
            auto body = nlohmann::json::parse(req.body);
            res = handleWrapperAction(
                body, "getFunctionList", [&body](auto wrapper) {
                    auto functions = wrapper->get_function_list(
                        body["alias"].get<std::string>());
                    return ResponseBuilder::success(
                        nlohmann::json{{"functions", functions}});
                });
        } catch (const nlohmann::json::exception& e) {
            res = ResponseBuilder::invalidJson(e.what());
        }
    ...
    void evalExpression(const crow::request& req, crow::response& res) {
        try {
            auto body = nlohmann::json::parse(req.body);
            res = handleWrapperAction(
                body, "evalExpression", [&body](auto wrapper) {
    ...
    void injectCode(const crow::request& req, crow::response& res) {
        try {
            auto body = nlohmann::json::parse(req.body);
            res =
                handleWrapperAction(body, "injectCode", [&body](auto wrapper) {
                    wrapper->inject_code(
    ...
    void callMethod(const crow::request& req, crow::response& res) {
        try {
            auto body = nlohmann::json::parse(req.body);
            res =
                handleWrapperAction(body, "callMethod", [&body](auto wrapper) {
                    py::args args;
    ...
    void getObjectAttribute(const crow::request& req, crow::response& res) {
        try {
            auto body = nlohmann::json::parse(req.body);
            res = handleWrapperAction(
                body, "getObjectAttribute", [&body](auto wrapper) {
                    auto result =
                        wrapper->template get_object_attribute<py::object>(
                            body["alias"].get<std::string>(),
                            body["class_name"].get<std::string>(),
    ...
    void setObjectAttribute(const crow::request& req, crow::response& res) {
        try {
            auto body = nlohmann::json::parse(req.body);
            res = handleWrapperAction(
                body, "setObjectAttribute", [&body](auto wrapper) {
    ...
    void addSysPath(const crow::request& req, crow::response& res) {
        try {
            auto body = nlohmann::json::parse(req.body);
            res =
                handleWrapperAction(body, "addSysPath", [&body](auto wrapper) {
    ...
    void discoverExports(const crow::request& req, crow::response& res) {
        try {
            auto body = nlohmann::json::parse(req.body);
            res = handleWrapperAction(
                body, "discoverExports", [&body](auto wrapper) {
                    auto exports = wrapper->discover_exports(
                        body["alias"].get<std::string>());
                    if (exports) {
    ...
    void invokeExport(const crow::request& req, crow::response& res) {
        try {
            auto body = nlohmann::json::parse(req.body);
            res = handleWrapperAction(
                body, "invokeExport", [&body](auto wrapper) {
                    py::dict kwargs;
                    if (body.contains("kwargs") && body["kwargs"].is_object()) {
                        for (auto& [key, val] : body["kwargs"].items()) {
                            if (val.is_string()) {
                                kwargs[key.c_str()] =
                                    py::str(val.get<std::string>());
                            } else if (val.is_number_integer()) {
                                kwargs[key.c_str()] =
                                    py::int_(val.get<int64_t>());
                            } else if (val.is_number_float()) {
                                kwargs[key.c_str()] =
                                    py::float_(val.get<double>());
                            } else if (val.is_boolean()) {
                                kwargs[key.c_str()] =
                                    py::bool_(val.get<bool>());
                            }
                        }
                    }
                    ...
                    auto result = wrapper->invoke_export(
                        body["alias"].get<std::string>(),
                        body["function_name"].get<std::string>(), kwargs);
                    return ResponseBuilder::success(nlohmann::json{
                        {"result", std::string(py::str(result))}});
                });
        } catch (const nlohmann::json::exception& e) {
