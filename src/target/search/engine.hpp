...
public:
     ...
     * @return Matching objects
     */
    std::vector<CelestialObjectModel> getByMagnitude(double minMag,
                                                     double maxMag,
                                                     int limit = 100);
     ...
     */
    std::vector<std::pair<CelestialObjectModel, double>>
    getModelRecommendations(const std::string& userId, int topN = 10);
