...
struct Version {
     ...
     */
    [[nodiscard]] static auto parse(std::string_view versionStr) -> Version;
...
struct DateVersion {
     ...
     */
    [[nodiscard]] static auto parse(std::string_view dateStr) -> DateVersion;
...
struct VersionRange {
     ...
     */
    [[nodiscard]] static auto parse(std::string_view rangeStr) -> VersionRange;
     ...
     */
    [[nodiscard]] static auto from(Version minVer) -> VersionRange;
     ...
     * @return Version range object
     */
    [[nodiscard]] static auto upTo(Version maxVer) -> VersionRange;
 ...
 * false otherwise
 */
[[nodiscard]] auto checkDateVersion(const DateVersion& actualVersion,
