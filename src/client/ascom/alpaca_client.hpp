...
public:
     ...
     */
    std::string getDeviceDescription(ASCOMDeviceType deviceType,
                                     int deviceNumber);
     ...
     */
    std::vector<std::string> getSupportedActions(ASCOMDeviceType deviceType,
                                                 int deviceNumber);
