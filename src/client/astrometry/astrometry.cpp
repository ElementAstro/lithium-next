...
PlateSolveResult AstrometrySolver::solve(
    ...
    return parseSolveOutput(output);
}
...
bool AstrometrySolver::configure(const SolveOptions& options) {
    options_ = options;
    return true;
}
...
double AstrometrySolver::toDegrees(double radians) {
    return radians * 180.0 / M_PI;
}

double AstrometrySolver::arcsecToDegree(double arcsec) {
