...
void registerBuiltInTasks() {
    ...
    factory.registerTask<camera::TimelapseTask>(
        "Timelapse", createTaskWrapper<camera::TimelapseTask>,
        timelapseInfo);

    // Register calibration tasks
    TaskInfo autoCalibrationInfo{
        .name = "AutoCalibration",
        .description = "Automatically acquire calibration frames (dark, bias, flat)",
        .category = "Calibration",
        .requiredParameters = {},
        .parameterSchema = json{
            {"dark_count", {{"type", "integer"}, {"minimum", 1}, {"default", 10}}},
            {"bias_count", {{"type", "integer"}, {"minimum", 1}, {"default", 20}}},
            {"flat_count", {{"type", "integer"}, {"minimum", 1}, {"default", 10}}},
    ...
    TaskInfo thermalCycleInfo{
        .name = "ThermalCycle",
        .description = "Acquire dark frames across temperature range for thermal calibration",
        .category = "Calibration",
        ...
        .parameterSchema = json{
            ...
            {"temp_step", {{"type", "number"}, {"minimum", 0.1}, {"default", 5.0}}},
            {"binning", {{"type", "integer"}, {"minimum", 1}, {"default", 1}}}
        },
        .version = "1.0.0",
        .dependencies = {},
    ...
    TaskInfo flatFieldSequenceInfo{
        ...
        .description = "Automated flat field frame acquisition with exposure control",
        .category = "Calibration",
        .requiredParameters = {},
        .parameterSchema = json{
            {"filter", {{"type", "string"}, {"default", "L"}}},
            {"count", {{"type", "integer"}, {"minimum", 1}, {"default", 10}}},
            {"target_adu", {{"type", "integer"}, {"minimum", 1000}, {"default", 30000}}},
            {"tolerance", {{"type", "number"}, {"minimum", 0.01}, {"default", 0.1}}},
            {"max_exposure", {{"type", "number"}, {"minimum", 0.001}, {"default", 30.0}}},
            {"min_exposure", {{"type", "number"}, {"minimum", 0.001}, {"default", 0.1}}},
            {"binning", {{"type", "integer"}, {"minimum", 1}, {"default", 1}}}
        },
        .version = "1.0.0",
        .dependencies = {},
    ...
    TaskInfo autoFocusInfo{
        ...
        .requiredParameters = {},
        .parameterSchema = json{
            {"exposure", {{"type", "number"}, {"minimum", 0.001}, {"default", 3.0}}},
            {"step_size", {{"type", "integer"}, {"minimum", 1}, {"default", 100}}},
            {"max_steps", {{"type", "integer"}, {"minimum", 3}, {"default", 15}}},
            {"binning", {{"type", "integer"}, {"minimum", 1}, {"default", 1}}},
            {"method", {{"type", "string"}, {"enum", json::array({"hfd", "fwhm", "contrast"})}, {"default", "hfd"}}}
        },
        .version = "1.0.0",
        .dependencies = {},
        .isEnabled = true
    ...
    factory.registerTask<camera::AutoFocusTask>(
        "AutoFocus", createTaskWrapper<camera::AutoFocusTask>,
        autoFocusInfo);
    ...
    TaskInfo temperatureFocusInfo{
        ...
        .requiredParameters = {},
        .parameterSchema = json{
            {"coefficient", {{"type", "number"}, {"default", -1.5}}},
            {"reference_temp", {{"type", "number"}, {"default", 20.0}}},
            {"current_temp", {{"type", "number"}}},
            {"max_adjustment", {{"type", "integer"}, {"minimum", 1}, {"default", 500}}}
        },
        .version = "1.0.0",
        .dependencies = {},
        .isEnabled = true
    ...
    TaskInfo autoGuidingInfo{
        ...
        .requiredParameters = {},
        .parameterSchema = json{
            {"settle_time", {{"type", "number"}, {"minimum", 0.0}, {"default", 10.0}}},
            {"settle_pixels", {{"type", "number"}, {"minimum", 0.1}, {"default", 1.5}}},
            {"settle_timeout", {{"type", "number"}, {"minimum", 0.0}, {"default", 30.0}}}
        },
        .version = "1.0.0",
        .dependencies = {},
        .isEnabled = true
    ...
    TaskInfo ditherSequenceInfo{
        ...
        .requiredParameters = {},
        .parameterSchema = json{
            {"pixels", {{"type", "number"}, {"minimum", 0.1}, {"default", 5.0}}},
            {"settle_time", {{"type", "number"}, {"minimum", 0.0}, {"default", 10.0}}},
            {"settle_pixels", {{"type", "number"}, {"minimum", 0.1}, {"default", 1.5}}},
            {"dither_count", {{"type", "integer"}, {"minimum", 1}, {"default", 5}}}
        },
        .version = "1.0.0",
        .dependencies = {"AutoGuiding"},
        .isEnabled = true
    ...
    TaskInfo weatherMonitorInfo{
        ...
        .requiredParameters = {},
        .parameterSchema = json{
            {"cloud_threshold", {{"type", "number"}, {"minimum", 0.0}, {"maximum", 100.0}, {"default", 30.0}}},
            {"wind_threshold", {{"type", "number"}, {"minimum", 0.0}, {"default", 35.0}}},
            {"rain_threshold", {{"type", "number"}, {"minimum", 0.0}, {"default", 0.1}}},
            {"check_interval", {{"type", "number"}, {"minimum", 1.0}, {"default", 60.0}}}
        },
        .version = "1.0.0",
        .dependencies = {},
        .isEnabled = true
    ...
    TaskInfo cloudDetectionInfo{
        ...
        .requiredParameters = {},
        .parameterSchema = json{
            {"exposure", {{"type", "number"}, {"minimum", 0.001}, {"default", 5.0}}},
            {"threshold", {{"type", "number"}, {"minimum", 0.0}, {"maximum", 100.0}, {"default", 30.0}}}
        },
        .version = "1.0.0",
        .dependencies = {},
        .isEnabled = true
    ...
    TaskInfo safetyShutdownInfo{
        ...
        .requiredParameters = {},
        .parameterSchema = json{
            {"park_mount", {{"type", "boolean"}, {"default", true}}},
    ...
    TaskInfo plateSolveExposureInfo{
        ...
        .parameterSchema = json{
            ...
            {"search_radius", {{"type", "number"}, {"minimum", 0.1}, {"default", 5.0}}},
            {"binning", {{"type", "integer"}, {"minimum", 1}, {"default", 1}}}
        },
        .version = "1.0.0",
        .dependencies = {},
    ...
    TaskInfo centeringInfo{
        .name = "Centering",
        .description = "Center target object in field of view using plate solving",
        .category = "Platesolve",
        .requiredParameters = {},
        .parameterSchema = json{
            {"exposure", {{"type", "number"}, {"minimum", 0.001}, {"default", 3.0}}},
            {"max_iterations", {{"type", "integer"}, {"minimum", 1}, {"default", 5}}},
            {"tolerance", {{"type", "number"}, {"minimum", 0.0}, {"default", 60.0}}}
        },
        .version = "1.0.0",
    ...
    factory.registerTask<camera::CenteringTask>(
        "Centering", createTaskWrapper<camera::CenteringTask>,
        centeringInfo);

    TaskInfo mosaicInfo{
        .name = "Mosaic",
        .description = "Automated mosaic imaging with plate solving and positioning",
        .category = "Platesolve",
        .requiredParameters = {"panels"},
        .parameterSchema = json{
            {"panels", {{"type", "array"}, {"items", {{"type", "object"}}}}},
            {"exposure", {{"type", "number"}, {"minimum", 0.001}}},
            {"overlap", {{"type", "number"}, {"minimum", 0.0}, {"maximum", 1.0}, {"default", 0.1}}}
        },
        .version = "1.0.0",
    ...
    factory.registerTask<camera::MosaicTask>(
        "Mosaic", createTaskWrapper<camera::MosaicTask>,
        mosaicInfo);
    ...
    factory.registerTask<LoadConfigTask>(
        "LoadConfig", createTaskWrapper<LoadConfigTask>,
        loadConfigInfo);
    ...
    TaskInfo runScriptInfo{
        ...
        .parameterSchema = json{
            ...
            {"script_type", {{"type", "string"}, {"enum", json::array({"python", "shell"})}, {"default", "python"}}},
            {"timeout", {{"type", "integer"}, {"minimum", 1}, {"default", 300}}},
            {"parameters", {{"type", "object"}, {"default", json::object()}}}
        },
        .version = "1.0.0",
        .dependencies = {},
        .isEnabled = true
    ...
    factory.registerTask<RunScriptTask>(
        "RunScript", createTaskWrapper<RunScriptTask>,
        runScriptInfo);
    ...
    factory.registerTask<TargetSearchTask>(
        "TargetSearch", createTaskWrapper<TargetSearchTask>,
        targetSearchInfo);
    ...
    TaskInfo saveConfigInfo{
        ...
        .parameterSchema = json{
            {"config_path", {{"type", "string"}}},
            {"profile", {{"type", "string"}, {"default", "default"}}},
            {"format", {{"type", "string"}, {"enum", json::array({"json", "yaml"})}, {"default", "json"}}}
        },
        .version = "1.0.0",
        .dependencies = {},
        .isEnabled = true
    ...
    factory.registerTask<SaveConfigTask>(
        "SaveConfig", createTaskWrapper<SaveConfigTask>,
        saveConfigInfo);
    ...
    factory.registerTask<RunWorkflowTask>(
        "RunWorkflow", createTaskWrapper<RunWorkflowTask>,
        runWorkflowInfo);
    ...
    TaskInfo mountSlewInfo{
        ...
        .parameterSchema = json{
            {"ra", {{"type", "number"}, {"minimum", 0.0}, {"maximum", 24.0}}},
            {"dec", {{"type", "number"}, {"minimum", -90.0}, {"maximum", 90.0}}},
            {"target_name", {{"type", "string"}, {"default", ""}}},
            {"sync_before_slew", {{"type", "boolean"}, {"default", false}}},
            {"wait_for_settle", {{"type", "boolean"}, {"default", true}}},
            {"settle_time", {{"type", "number"}, {"minimum", 0.0}, {"default", 5.0}}}
        },
        .version = "1.0.0",
        .dependencies = {},
        .isEnabled = true
    ...
    factory.registerTask<MountSlewTask>(
        "MountSlew", createTaskWrapper<MountSlewTask>,
        mountSlewInfo);
    ...
    TaskInfo mountParkInfo{
        ...
        .requiredParameters = {},
        .parameterSchema = json{
            {"park_position", {{"type", "string"}, {"default", "default"}}},
            {"wait_for_complete", {{"type", "boolean"}, {"default", true}}}
        },
        .version = "1.0.0",
        .dependencies = {},
        .isEnabled = true
    ...
    factory.registerTask<MountParkTask>(
        "MountPark", createTaskWrapper<MountParkTask>,
        mountParkInfo);
    ...
    TaskInfo mountTrackInfo{
        ...
        .requiredParameters = {},
        .parameterSchema = json{
            {"tracking_mode", {{"type", "string"}, {"enum", json::array({"sidereal", "lunar", "solar", "custom"})}, {"default", "sidereal"}}},
    ...
    factory.registerTask<MountTrackTask>(
        "MountTrack", createTaskWrapper<MountTrackTask>,
        mountTrackInfo);
    ...
    factory.registerTask<FocuserMoveTask>(
        "FocuserMove", createTaskWrapper<FocuserMoveTask>,
        focuserMoveInfo);
    ...
    TaskInfo targetAcquisitionInfo{
        ...
        .description = "Complete target acquisition workflow (slew, plate solve, center, guide, focus)",
        .category = "Workflow",
        ...
        .parameterSchema = json{
            ...
            {"perform_autofocus", {{"type", "boolean"}, {"default", true}}}
        },
        .version = "1.0.0",
        .dependencies = {},
        .isEnabled = true
    ...
    TaskInfo exposureSequenceInfo{
        ...
        .description = "Execute exposure sequence for a target with filter changes and dithering",
        .category = "Workflow",
    ...
    TaskInfo sessionInfo{
        ...
        .parameterSchema = json{
            ...
            {"targets", {{"type", "array"}}},
            {"camera_cooling_temp", {{"type", "number"}, {"default", -10.0}}}
        },
        .version = "1.0.0",
        .dependencies = {},
        .isEnabled = true
    ...
    factory.registerTask<workflow::SessionTask>(
        "Session", createTaskWrapper<workflow::SessionTask>,
        sessionInfo);
    ...
    TaskInfo safetyCheckInfo{
        ...
        .requiredParameters = {},
        .parameterSchema = json{
            {"check_weather", {{"type", "boolean"}, {"default", true}}}
        },
        .version = "1.0.0",
        .dependencies = {},
        .isEnabled = true
    ...
    factory.registerTask<workflow::DitherTask>(
        "Dither", createTaskWrapper<workflow::DitherTask>,
        ditherInfo);
    ...
    TaskInfo waitInfo{
        ...
        .parameterSchema = json{
            {"wait_type", {{"type", "string"}, {"enum", json::array({"duration", "time", "altitude", "twilight"})}}},
    ...
    factory.registerTask<workflow::WaitTask>(
        "Wait", createTaskWrapper<workflow::WaitTask>,
        waitInfo);
    ...
    TaskInfo calibrationFrameInfo{
        ...
        .parameterSchema = json{
            {"frame_type", {{"type", "string"}, {"enum", json::array({"dark", "flat", "bias"})}}},
            {"count", {{"type", "integer"}, {"minimum", 1}}},
