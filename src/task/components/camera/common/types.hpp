...
#ifndef LITHIUM_TASK_COMPONENTS_CAMERA_COMMON_TYPES_HPP
#define LITHIUM_TASK_COMPONENTS_CAMERA_COMMON_TYPES_HPP
...
#endif  // LITHIUM_TASK_COMPONENTS_CAMERA_COMMON_TYPES_HPP
