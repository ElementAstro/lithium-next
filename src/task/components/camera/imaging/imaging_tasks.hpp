...
#ifndef LITHIUM_TASK_COMPONENTS_CAMERA_IMAGING_TASKS_HPP
#define LITHIUM_TASK_COMPONENTS_CAMERA_IMAGING_TASKS_HPP
...
#endif  // LITHIUM_TASK_COMPONENTS_CAMERA_IMAGING_TASKS_HPP
