...
#ifndef LITHIUM_TASK_COMPONENTS_COMMON_TASK_BASE_HPP
#define LITHIUM_TASK_COMPONENTS_COMMON_TASK_BASE_HPP
...
#endif  // LITHIUM_TASK_COMPONENTS_COMMON_TASK_BASE_HPP
