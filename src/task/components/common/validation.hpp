...
#ifndef LITHIUM_TASK_COMPONENTS_COMMON_VALIDATION_HPP
#define LITHIUM_TASK_COMPONENTS_COMMON_VALIDATION_HPP
...
#endif  // LITHIUM_TASK_COMPONENTS_COMMON_VALIDATION_HPP
