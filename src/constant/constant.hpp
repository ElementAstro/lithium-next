...
public:
    ...
    DEFINE_LITHIUM_CONSTANT(DATABASE_MANAGER)
    ...
    DEFINE_LITHIUM_CONSTANT(COMMAND_DISPATCHER)
    DEFINE_LITHIUM_CONSTANT(EVENT_LOOP)
    ...
    DEFINE_LITHIUM_CONSTANT(EXPOSURE_SEQUENCE)

    DEFINE_LITHIUM_CONSTANT(SCRIPT_MANAGER)
    DEFINE_LITHIUM_CONSTANT(PYTHON_WRAPPER)
    DEFINE_LITHIUM_CONSTANT(SCRIPT_ANALYZER)

    // Unified Script Service (integrates all script components)
    DEFINE_LITHIUM_CONSTANT(SCRIPT_SERVICE)

    // Enhanced script engine components (accessible via ScriptService)
    DEFINE_LITHIUM_CONSTANT(PYTHON_TOOL_REGISTRY)
    DEFINE_LITHIUM_CONSTANT(ISOLATED_PYTHON_RUNNER)
    DEFINE_LITHIUM_CONSTANT(INTERPRETER_POOL)
    DEFINE_LITHIUM_CONSTANT(VENV_MANAGER)
    DEFINE_LITHIUM_CONSTANT(IPC_CHANNEL)
    DEFINE_LITHIUM_CONSTANT(PYTHON_SCRIPT_MANAGER)
    DEFINE_LITHIUM_CONSTANT(PYTHON_SCRIPT_REGISTRY)
    ...
    DEFINE_LITHIUM_CONSTANT(SEARCH_ENGINE)

    // Plugin System
    DEFINE_LITHIUM_CONSTANT(PLUGIN_MANAGER)
    DEFINE_LITHIUM_CONSTANT(PLUGIN_LOADER)
