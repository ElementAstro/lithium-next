 ...
 */
[[nodiscard]] constexpr std::string_view venvErrorToString(VenvError error) noexcept {
    switch (error) {
        case VenvError::Success: return "Success";
        case VenvError::PythonNotFound: return "Python interpreter not found";
        case VenvError::CondaNotFound: return "Conda not found";
        case VenvError::VenvCreationFailed: return "Virtual environment creation failed";
        case VenvError::VenvActivationFailed: return "Virtual environment activation failed";
        case VenvError::VenvNotFound: return "Virtual environment not found";
        case VenvError::PackageInstallFailed: return "Package installation failed";
        case VenvError::PackageUninstallFailed: return "Package uninstallation failed";
        case VenvError::RequirementsNotFound: return "Requirements file not found";
        case VenvError::PermissionDenied: return "Permission denied";
        case VenvError::NetworkError: return "Network error";
        case VenvError::InvalidPath: return "Invalid path";
        case VenvError::AlreadyExists: return "Environment already exists";
        case VenvError::InvalidEnvironment: return "Invalid environment";
        case VenvError::TimeoutError: return "Operation timed out";
        case VenvError::UnknownError: return "Unknown error";
    }
...
struct VenvConfig {
    std::filesystem::path path;           ///< Environment path
    std::string pythonVersion;            ///< Desired Python version (empty = system default)
    ...
    std::vector<std::string> extraPackages;  ///< Packages to install after creation
};
 ...
 */
using ProgressCallback = std::function<void(float progress, std::string_view message)>;
