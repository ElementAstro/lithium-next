...
class BuildSystemError(Exception):
    ...
    def with_context(self, **kwargs: Any) -> BuildSystemError:
        ...
        new_context = ErrorContext(
            ...
            working_directory=kwargs.get('working_directory', self.context.working_directory),
            environment_vars={**self.context.environment_vars, **kwargs.get('environment_vars', {})},
            ...
            additional_info={**self.context.additional_info, **kwargs.get('additional_info', {})}
        )
