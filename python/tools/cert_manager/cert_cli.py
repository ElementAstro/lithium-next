...
from .cert_operations import (
    create_self_signed_cert, view_cert_details, check_cert_expiry,
    renew_cert, export_to_pkcs12
)
...
def run_cli() -> int:
    ...
    parser.add_argument("--cert-type", default="server", 
    ...
    try:
        ...
        if args.create:
            ...
            if not args.cert_file or not args.key_file or not args.pfx_password:
                logger.error("Certificate, key, and password are required for PFX export")
                return 1
