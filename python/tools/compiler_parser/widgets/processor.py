...
class CompilerProcessorWidget:
    ...
    def process_file(
        self, compiler_type: Union[CompilerType, str], file_path: Union[str, Path]
    ) -> CompilerOutput:
    ...
    def process_files(
        ...
        with ThreadPoolExecutor(max_workers=concurrency) as executor:
            ...
            futures = {
                executor.submit(self.process_file, compiler_type, file_path): file_path
    ...
    def process_string(
        self, compiler_type: Union[CompilerType, str], output: str
    ) -> CompilerOutput:
