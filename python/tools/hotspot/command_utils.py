...
from typing import (
    Any, AsyncContextManager, AsyncGenerator, AsyncIterator, Callable, Dict, List, Optional, 
    Sequence, Union
)
...
class CommandValidator:
    ...
    ALLOWED_COMMANDS = {
        'nmcli', 'iw', 'arp', 'ip', 'ifconfig', 'systemctl', 'hostapd', 
        'dnsmasq', 'iptables', 'ufw', 'firewall-cmd'
    }
