...
class FileStatus:
    ...
    def is_conflicted(self) -> bool:
        ...
        return self.x_status == GitStatusCode.UNMERGED or self.y_status == GitStatusCode.UNMERGED
    
    @cached_property
    def is_renamed(self) -> bool:
        """Whether the file was renamed."""
        return self.x_status == GitStatusCode.RENAMED or self.y_status == GitStatusCode.RENAMED
