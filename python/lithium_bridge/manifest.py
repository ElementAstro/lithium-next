...
def merge_manifests(*manifests: Dict[str, Any]) -> Dict[str, Any]:
    ...
    for manifest in manifests:
        ...
        result["exports"]["controllers"].extend(exports.get("controllers", []))
        result["exports"]["commands"].extend(exports.get("commands", []))
...
class ManifestLoader:
    ...
    def load_from_directory(
        ...
        pattern = (
            f"**/{self.manifest_filename}" if recursive else self.manifest_filename
        )
